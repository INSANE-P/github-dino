/**
 * @generated SignedSource<<e314620c1e2a56246d8ade225f931df1>>
...
return {
  ...
  "params": {
    "cacheID": "b18c0859aebd2074f6320a1c0e3280a4",
    "id": null,
    "metadata": {},
    "name": "RepoListPaginationQuery",
    "operationKind": "query",
    "text": "query RepoListPaginationQuery(\n  $count: Int = 6\n  $cursor: String\n  $id: ID!\n) {\n  node(id: $id) {\n    __typename\n    ...RepoList_user_1G22uz\n    id\n  }\n}\n\nfragment RepoList_user_1G22uz on User {\n  repositories(first: $count, after: $cursor, orderBy: {field: UPDATED_AT, direction: DESC}, ownerAffiliations: [OWNER], isFork: false) {\n    edges {\n      node {\n        id\n        name\n        description\n        url\n        stargazerCount\n        primaryLanguage {\n          name\n          id\n        }\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n  id\n}\n"
  }
};
})();
